...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name' => 'contact-form-7',
            'slug' => 'contact-form-7',
            'source' => get_template_directory_uri() .'/inc/plugins/contact-form-7.4.2.2.zip',
            'required' => true,
            'version' => '4.2.2',
            'force_activation' => false,
            'force_deactivation' => false
				...
				// Options Framework
        array(
            'name' => 'options-framework.1.8.4',
            'slug' => 'options-framework',
            'source' => get_template_directory_uri() .'/inc/plugins/options-framework.1.8.4.zip',
            'required' => true,
            'version' => '1.8.4',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            ...
            'source' => get_template_directory_uri() .'/inc/plugins/wordpress-importer.0.6.1.zip',
            'required' => true,
            'version' => '0.6.1',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            'name' => 'whmcs-bridge',
            'slug' => 'whmcs-bridge',
            'source' => get_template_directory_uri() .'/inc/plugins/whmcs-bridge.3.4.6.zip',
            'required' => true,
            'version' => '3.4.6',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            'name' => 'twitters-bootstrap-shortcodes-ultimate-master',
            'slug' => 'twitters-bootstrap-shortcodes-ultimate-master',
            'source' => get_template_directory_uri() .'/inc/plugins/twitters-bootstrap-shortcodes-ultimate-master.zip',
            'required' => true,
            'version' => '1.0',
            'force_activation' => false,
            'force_deactivation' => false
