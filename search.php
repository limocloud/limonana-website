    ...
    <div class="container">
        <div class="row">
           ...
           ?>
            ...
            <div class="<?php echo ($megahost_pos == '2') ? 'row' : 'col-md-9';?>">
                  
                <?php
                    $megahost_paginar=1;
										$megahost_posts_per_page='';
                    $megahost_cat = array();
                    $megahost_paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
                    
                    $megahost_search_query = get_query_var('s');      
                    $megahost_post_per_page = get_query_var('s');
                    $megahost_post_per_page = get_query_var('post_per_page');
                    query_posts('s='.$megahost_search_query.'&posts_per_page='.$megahost_posts_per_page.'&paged='.$megahost_paged);
